...
// Hmm, I made all these functions at some point.
// I should def. review these.
...
main()
{
	...
	do{
		...
		do{
			...
			cin>>stringmenu;
		}while(stringmenu != 1 && stringmenu != 2 && stringmenu != 3 
			&& stringmenu != 4 && stringmenu != 5 && stringmenu != 6 && stringmenu != 7);
